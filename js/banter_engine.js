...
const BanterEngine = {
    ...
    _data: {
        1: { level_start: [
            ...
            {s:'N', l:"Cybernetic jellyfish swarm is overloading my shields! I'm pulling back to the reef edge!", r:{s:'C', l:"Copy that, Naya. Peel away, I'll draw their electric arcs."}},
            {s:'C', l:"Hydrothermal vent eruption just scorched my port thruster. Breaking formation now!", r:{s:'T', l:"Valera, get clear of the thermal plume. I'll cover your flank."}},
        ...
        2: { level_start: [
            ...
            {s:'C', l:"Graveyard Leviathan is targeting my signatures. Tactical retreat before I'm swallowed!", r:{s:'D', l:"Draw it to the trench line, Cross. I'm right behind you."}},
            ...
            {s:'A', l:"The graves are empty... yet they sing of the ending... we will not let you disturb the dust!", r:{s:'C', l:"Nightmare spike detected! Break off, squad, before it scrambles our navigation!"}},
            ...
            {s:'C', l:"Lightning storms between these ossified spires are cooking my circuits! I'm pulling back to the neutral zone!", r:{s:'T', l:"The storm cycles every forty seconds, Cross. Time your retreat between arcs."}},
        ]},
        3: { level_start: [
            ...
            {s:'N', l:"Half-formed Coelacanths are swarming my cockpit glass! Breaking off to shake them!", r:{s:'C', l:"Roll seventy degrees, Naya. I'll clean them off with flak."}},
            {s:'C', l:"Cryo-mines just cracked my secondary shield. I'm pulling out to seal the hull!", r:{s:'T', l:"Go, Cross. I'll drop thermal flares to keep the swarms off your engines."}},
            ...
            {s:'C', l:"Steam vents just ruptured my heat shielding! These engine pipes are a maze of superheated death. Breaking off!", r:{s:'O', l:"The Coelacanth's thermal regulation system is malfunctioning, Captain. Retreat to the coolant junction."}},
        ]},
        4: { level_start: [
            ...
            {s:'D', l:"Reality is warping my hull geometry! My thrusters are firing backward! Pulling out!", r:{s:'C', l:"Calibrate to the local gravity well, Star. Fall back and reset."}},
            ...
            {s:'C', l:"Cosmic storm is ionizing my capacitor. Shields dropping to twenty. Breaking off!", r:{s:'T', l:"Valera, head for the nebula's shadow. I'll cover your signature."}},
        ...
        5: { level_start: [
            ...
            {s:'C', l:"My former wingmen are hunting my signature. I can't fire on my own squad. Pulling back!", r:{s:'N', l:"I understand, Valera. Go. I'll cover the retreat."}},
            ...
            {s:'O', l:"The kinetic impactors are too dense in this ring sector. My shielding is failing. Disengaging!", r:{s:'C', l:"Get behind my plating, Ophion. We're pulling back to the dust gap."}},
            ...
            {s:'T', l:"Absolute zero temperatures are freezing my fuel lines solid. Thrusters are sluggish. Pulling back before I'm a frozen hulk!", r:{s:'C', l:"Thorne, vent your exhaust ports! I'll push you clear of the cryo-dead zone."}},
        ]},
        6: { level_start: [
